package OpenMV.Image is
   ...
   function To_RGB (C : Color) return RGB_Float with Inline_Always;
   function To_HSV (C : RGB_Float) return HSV_Color with Inline_Always;
   function To_LAB (C : Color) return LAB_Color with Inline_Always;
   function Distance (C1, C2 : LAB_Color) return Float with Inline_Always;
   function Distance (C1, C2 : Color) return Float with Inline_Always;
